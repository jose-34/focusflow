...
| `/classes/$classId` (`classes.$classId.index.tsx`) | Built | [B4](04_Product_Requirements_Document.md#b4-roster--enrollment-management) roster (teacher) or class info (student); quiz list. | Student, Teacher | Planned: a "Manage Practice Tasks" panel added here for teachers once [C2](04_Product_Requirements_Document.md#c2-practice-task-assignment) ships — extends this page, not a new route. |
