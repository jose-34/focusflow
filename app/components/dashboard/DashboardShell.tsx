...
export function DashboardShell({ title, subtitle, children, decorated = true }: DashboardShellProps) {
  return (
    <div className="relative mx-auto max-w-6xl overflow-hidden px-4 py-10">
      {decorated && <OrganicBlob colorClassName="bg-accent/40" className="-top-16 -right-32" />}
